    ...
    return (
        <div className="">
            ...
            {data && data.length > 0 &&
                ...
                >
                    <ul
                        className={`py-2 text-sm text-primary font-medium dark:text-gray-200 grid grid-rows-10 grid-flow-col gap-x-[30px]`}
                        ...
                        <li>
                            <a
                                ...
                                className={clsx(`flex flex-row items-center px-4 py-2 group
                                    ${selectedCoinList && selectedCoinList.length === data.length && data.length > 0 ? 'font-bold text-secondary' : 'font-medium text-primary'}
