...
AboutUsPage.getLayout = function getLayout(page) {
  return <Layout variant="about-us">{page}</Layout>;
};


const kagan = "/assets/imgs/landing/team members/kagan.png";
const barrett = "/assets/imgs/landing/team members/barrett.png";
const amir = "/assets/imgs/landing/team members/amir.png";
const ronald = "/assets/imgs/landing/team members/ronald.png";
const socialIcon = "/assets/imgs/landing/social icon.png";
